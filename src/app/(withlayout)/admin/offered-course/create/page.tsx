...
import { useAddOfferedCourseMutation } from "@/redux/api/offered-courseApi";
import { useSemesterRegistrationsQuery } from "@/redux/api/semester-registrationApi";
            ...
            <Form submitHandler={onSubmit}>
                <Row gutter={{ xs: 24, xl: 8, lg: 8, md: 24 }}>
                    <Col span={8} style={{ margin: "10px 0" }}>
                        ...
                        <div style={{ margin: "10px 0px" }}>
                            <OfferedCoursesField name="courseIds" label="Courses" placeholder="Select"
                            />
                        </div>
